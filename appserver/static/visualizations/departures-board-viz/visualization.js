...
/***/ (function(module, exports, __webpack_require__) {
	...
	var departures_board = function () {
		function departures_board() {
			_classCallCheck(this, departures_board);
		...
		_createClass(departures_board, [{
			key: "setConfig",
			value: function setConfig(config, namespace, mvc) {
				...
				if (reValidateRefreshPeriod.test(this.auto_refresh_period) != true || this.auto_refresh_period < 1) {
					this.auto_refresh_period = 5;
				}

				//Timing mus be at least 100ms
				var reValidateAnimationPeriod = new RegExp("\\d{3,4}");
				if (reValidateAnimationPeriod.test(this.timing) != true || this.timing < 100) {
					this.timing = 500;
				}
			}
		}, {
			...
			value: function getHTML() {
				...
				var html = "<div class=\"dbv_container\" style=\"" + cssAlign + "\"><div class=\"dvb_sub_container\"><input class=\"header " + cssTheme + " " + this.size + "\" id=\"" + this.id + "\" /><div class=\"dbv_label\">" + this.label + "</div></div></div>";
				return html;
			}
			...
			key: "_setToken",
			value: function _setToken(name, value) {
