class departures_board{
	...
	start(){
		...
		go(){
			...
			$("#" + this.id).val(this.caption).change();
			var thisObj = this;	
			...
			if(this.auto_refresh){
				window.setInterval(function(){
						...
						var tokens={"term": {"key": token_word, "value": thisObj.caption},"id": {"key": token_id, "value":thisObj.value}}
						thisObj.setTokens(tokens);
		...
		_setToken(name, value) {
			...
			var submittedTokenModel = this..Components.get('submitted');
