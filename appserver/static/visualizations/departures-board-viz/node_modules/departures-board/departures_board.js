class departures_board{
	...
	setConfig(config, namespace, mvc){
		// Get Config parameters:
			...
			this.label = config[namespace + "label"] || true;
	...
	getHTML(){
		...
		var align= "text-align: " + this.align;
		var html = "<div class=\"dbv_container\" style=\"text-align:" + this.align +  ";\"><input class=\"header " + cssTheme + " " + this.size +"\" id=\"" + this.id + "\" /><div class=\"dbv_label\">" + this.label + "</div></div>";
		return html;
	}
