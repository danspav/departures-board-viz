class departures_board{
	constructor(num_characters, is_animated, timing, auto_refresh, auto_refresh_period, dark_tiles, size, force_all_caps, is_fixed_length, alignment){
	...
	getNextWord(){
		try{
			...
			if(this.align=="center"){
				paddingCount=Math.floor((this.num_characters - vals["word"].length)/2)
				padding = Array(paddingCount +1).join(" ")
