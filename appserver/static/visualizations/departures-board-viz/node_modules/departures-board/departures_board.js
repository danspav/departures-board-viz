class departures_board{
	constructor(num_characters, is_animated, timing, auto_refresh, auto_refresh_period, dark_tiles, size, force_all_caps, auto_size){
		...
		this.auto_size = (this.auto_size=="true");
	...
	setText(data){
			...
			try{
				...
				for(i=0;i<data.rows.length;i++){
					...
					if(this.auto_size){ if(str.length > this.num_characters) this.num_characters = str.length}
				}// loop
